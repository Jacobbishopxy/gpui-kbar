...
impl Render for ChartView {
    fn render(&mut self, _window: &mut Window, _cx: &mut Context<Self>) -> impl IntoElement {
        ...
        let watchlist_panel = build_watchlist_panel(self, _cx);
...
fn build_watchlist_panel(view: &mut ChartView, cx: &mut Context<ChartView>) -> Div {
    let watchlist_list = build_watchlist_list(view, cx);
...
fn build_watchlist_list(view: &mut ChartView, cx: &mut Context<ChartView>) -> Div {
