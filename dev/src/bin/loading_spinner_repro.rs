...
const USE_TIMER_REFRESH: bool = false;
const LOAD_DURATION_MS: u64 = 3000;
...
impl Render for ReproView {
    fn render(&mut self, window: &mut Window, cx: &mut GpuiContext<Self>) -> impl IntoElement {
        let on_click = cx.listener(|view: &mut ReproView, _, window, cx| {
        ...
        div()
                ...
                div()
                    ...
                    .child(if self.loading {
                        div()
                            ...
                            .items_center()
                            .gap_2()
                            .child(loading_sand(24.0, rgb(0xf59e0b)))
                            .child(
                                div()
                                    .text_sm()
                                    .text_color(gpui::white())
            ...
            .child(div().text_xs().text_color(rgb(0x9ca3af)).child(format!(
                "RAF in render: {}, pump: {}, timer: {}, duration: {}ms",
