...
- [x] Added Interval type and duration helper to support minute/hour/day bucket sizes.
- [x] Implemented bounds calculation across candles and a resample function that aggregates OHLCV per interval.
- [x] Added unit test covering bounds and resampling behavior.
